...
<jsp:include page="/wap/header.jsp" ><jsp:param name="head" value="index" /></jsp:include>
	<div class="confirm">
		...
		<table>
			<tr>
				...
				<td><img src="/wap/images/buy_phone.jpg" alt=""></td>
				<td>${subject}</td>
	...
	<div style="display:none;">
		<div class="success">
			...
			<h4><img src="/wap/images/dialog_success.png" />支付成功</h4>
			
			<b style="background:#acadbc;color:#fff;"><a href="wapindex.shtml">关闭</a></b>
		</div>
		
		<div class="error">
			<h3>订单号：<%=out_trade_no %></h3>
			<h4><img src="/wap/images/dialog_error.png" />支付失败</h4>
			
			<b><a href="wapindex.shtml">关闭</a></b>
		</div>
